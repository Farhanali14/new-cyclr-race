...
function preload(){
    ...
    //opponent pink cycle
    oppPink1Img = loadAnimation("images/opponent1.png",
                                "images/opponent2.png");
    oppPink2Img = loadAnimation("images/opponent3.png");

   //opponent yellow cycle
    oppYellow1Img = loadAnimation("images/opponent4.png",
                                  "images/opponent5.png");
    oppYellow2Img = loadAnimation("images/opponent6.png");

   //opponent red cycle
    oppRed1Img = loadAnimation("images/opponent7.png",
...
//set collider for mainCyclist
 mainCyclist.setCollider("rectangle",0,0,mainCyclist.width,
 mainCyclist.height);
...
function draw() {
  ...
  //move cyclist with your mouse
   mainCyclist.y = World.mouseY;
  
  //create edges and collide cyclist with edges
  ...
  // call opponents with framecount
